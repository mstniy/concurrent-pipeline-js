...
Diving the work into stages allows streams in different stages of execution to run concurrently. Note that the second argument controls the maximum number of streams allowed to be in this stage.
